...
## [0.5.0](https://github.com/Sekers/SKYAPI/tree/0.5.0) - (2026-08-06)
...
- Fixed a corrupted tokens file returning nothing instead of the intended "Key JSON tokens file is missing, corrupted or invalid" message, the same non-terminating `ConvertFrom-Json` problem as above.
