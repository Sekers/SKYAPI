function Get-SchoolActivityRoster
{
    <#
        .LINK
        ...
        .LINK
        Endpoint: https://developer.sky.blackbaud.com/api#api=school&operation=V1ActivitiesRostersGet
        
        .SYNOPSIS
        Education Management School API - Returns the activity rosters for a selected year.
        ...
        The school year to get activity sections for. You can specify either the ID or label of the school year (Get-SchoolYear). Defaults to the current school year if not specified.
    ...
    # Set the endpoints
    $endpoint = 'https://api.sky.blackbaud.com/school/v1/activities/rosters'
