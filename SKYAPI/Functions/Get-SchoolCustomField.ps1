function Get-SchoolCustomField
{
    <#
        .LINK
        ...
        .LINK
        Endpoint: https://developer.sky.blackbaud.com/api#api=school&operation=V1CustomfieldsGet
        
        .SYNOPSIS
        Education Management School API - Returns a collection of admin custom fields.
    ...
    # Set the endpoints
    $endpoint = 'https://api.sky.blackbaud.com/school/v1/customfields'
