...
This module started out with a focus on working with the Blackbaud SKY API [Education Management School API](https://developer.blackbaud.com/skyapi/products/bbem) but [SKY API endpoints](https://developer.blackbaud.com/skyapi/products) for [OneRoster](https://developer.blackbaud.com/skyapi/products/bbem/oneroster), [Raiser's Edge NXT]([https://developer.blackbaud.com/skyapi/renxt](https://developer.blackbaud.com/skyapi/products/renxt)), [Financial Edge NXT](https://developer.blackbaud.com/skyapi/products/fenxt), etc. are being added in. It is designed so that additional endpoints can be added in quickly & easily.
